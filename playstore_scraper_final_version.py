...
con=pymysql.connect(host="localhost", user="root", passwd="",db="playstore_apps_db",charset="utf8mb4", use_unicode=True)
...
mycursor.execute("""
                ...
                SELECT app_url FROM apps_urls WHERE id>1 AND id<=50 AND status=0
